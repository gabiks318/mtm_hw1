...
bool testBigEventManager() {
    ...
    Date event_date4 = dateCreate(1,1,2021);
    ...
    Date new_date_to_event_4 = dateCreate(29,12,2020);
    debugPrint("1\n");
    ...
    ASSERT_TEST(emAddEventByDate(em, event_name_same_as_1, event_date3, 6) == EM_SUCCESS,destroyDates);
        debugPrint("3");

    ASSERT_TEST(emChangeEventDate(em, 6, event_date1) == EM_EVENT_ALREADY_EXISTS,destroyDates);
        debugPrint("4");

    ASSERT_TEST(emGetEventsAmount(em) == 5, destroyDates);
    ASSERT_TEST(emRemoveEvent(em, 6) == EM_SUCCESS,destroyDates);
        debugPrint("5");

    ASSERT_TEST(emGetEventsAmount(em) == 4, destroyDates);

    ASSERT_TEST(strcmp(emGetNextEvent(em), event_name1) == 0, destroyDates);
        debugPrint("6");

    //adding 5 members
    ASSERT_TEST(emAddMember(em, "yan1", 1) == EM_SUCCESS, destroyDates);
    ASSERT_TEST(emAddMember(em, "yan2", 2) == EM_SUCCESS, destroyDates);
    ASSERT_TEST(emAddMember(em, "yan3", 3) == EM_SUCCESS, destroyDates);
    ASSERT_TEST(emAddMember(em, "yan4", 4) == EM_SUCCESS, destroyDates);
    ASSERT_TEST(emAddMember(em, "yan5", 5) == EM_SUCCESS, destroyDates);
    ASSERT_TEST(emAddMember(em, "yan6", 5) == EM_MEMBER_ID_ALREADY_EXISTS, destroyDates);
    ...
    /*  member 1- events 1,2,3,4
        ...
        member 4 - events 2
        member 5 - events 2,4*/
    ASSERT_TEST(emAddMemberToEvent(em, 1 , 1) == EM_SUCCESS, destroyDates);
    ASSERT_TEST(emAddMemberToEvent(em, 1 , 2) == EM_SUCCESS, destroyDates);
    ASSERT_TEST(emAddMemberToEvent(em, 1 , 3) == EM_SUCCESS, destroyDates);
    ASSERT_TEST(emAddMemberToEvent(em, 1 , 4) == EM_SUCCESS, destroyDates);
    ASSERT_TEST(emAddMemberToEvent(em, 2 , 2) == EM_SUCCESS, destroyDates);
    ASSERT_TEST(emAddMemberToEvent(em, 2 , 3) == EM_SUCCESS, destroyDates);
    ASSERT_TEST(emAddMemberToEvent(em, 3 , 2) == EM_SUCCESS, destroyDates);
    ASSERT_TEST(emAddMemberToEvent(em, 4 , 2) == EM_SUCCESS, destroyDates);
    ASSERT_TEST(emAddMemberToEvent(em, 5 , 1) == EM_SUCCESS, destroyDates);
    ASSERT_TEST(emAddMemberToEvent(em, 5 , 2) == EM_SUCCESS, destroyDates);
    ASSERT_TEST(emAddMemberToEvent(em, 5 , 4) == EM_SUCCESS, destroyDates);

    ASSERT_TEST(emAddMemberToEvent(em, 2 , 10) == EM_EVENT_ID_NOT_EXISTS, destroyDates);
    ASSERT_TEST(emAddMemberToEvent(em, 8 , 1) == EM_MEMBER_ID_NOT_EXISTS, destroyDates);
    ASSERT_TEST(emAddMemberToEvent(em, 1 , 1) == EM_EVENT_AND_MEMBER_ALREADY_LINKED, destroyDates);
    ASSERT_TEST(emRemoveMemberFromEvent(em, 1 , 1) == EM_SUCCESS, destroyDates);
    ASSERT_TEST(emAddMemberToEvent(em, 1 , 1) == EM_SUCCESS, destroyDates);
    ASSERT_TEST(emRemoveMemberFromEvent(em, 2 , 10) == EM_EVENT_ID_NOT_EXISTS, destroyDates);
    ASSERT_TEST(emRemoveMemberFromEvent(em, 8 , 1) == EM_MEMBER_ID_NOT_EXISTS, destroyDates);
    ASSERT_TEST(emRemoveMemberFromEvent(em, 2 , 1) == EM_EVENT_AND_MEMBER_NOT_LINKED, destroyDates);
